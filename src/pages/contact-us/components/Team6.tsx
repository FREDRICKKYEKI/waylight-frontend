      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 items-start justify-center gap-x-8 gap-y-12 md:grid-cols-3 md:gap-x-8 md:gap-y-16 lg:gap-x-12">
          <div className="flex flex-col text-center">
            ...
            <p>John ensures projects run smoothly and on schedule.</p>
          ...
          <div className="flex flex-col text-center">
            ...
            <div className="mb-3 md:mb-4">
              ...
              <h6 className="md:text-md">Design Specialist</h6>
            </div>
            <p>Jane creates innovative designs tailored to client needs.</p>
            <div className="mt-6 grid grid-flow-col grid-cols-[max-content] gap-3.5 self-center">
              <a href="#">
                <BiLogoLinkedinSquare className="size-6" />
              </a>
          ...
          <div className="flex flex-col text-center">
            ...
            <div className="mb-3 md:mb-4">
              <h5 className="text-md font-semibold md:text-lg">Mike Johnson</h5>
              <h6 className="md:text-md">Sales Executive</h6>
            </div>
            <p>Mike connects clients with the perfect shade solutions.</p>
            <div className="mt-6 grid grid-flow-col grid-cols-[max-content] gap-3.5 self-center">
              <a href="#">
                <BiLogoLinkedinSquare className="size-6" />
              </a>
          ...
          <div className="flex flex-col text-center">
            ...
            <div className="mb-3 md:mb-4">
              <h5 className="text-md font-semibold md:text-lg">Emily Davis</h5>
              <h6 className="md:text-md">Customer Support</h6>
            </div>
            <p>Emily assists clients with inquiries and support.</p>
            <div className="mt-6 grid grid-flow-col grid-cols-[max-content] gap-3.5 self-center">
              <a href="#">
                <BiLogoLinkedinSquare className="size-6" />
              </a>
          ...
          <div className="flex flex-col text-center">
            ...
            <div className="mb-3 md:mb-4">
              <h5 className="text-md font-semibold md:text-lg">Chris Lee</h5>
              <h6 className="md:text-md">Installation Expert</h6>
            </div>
            <p>Chris ensures every installation meets our high standards.</p>
            <div className="mt-6 grid grid-flow-col grid-cols-[max-content] gap-3.5 self-center">
              <a href="#">
                <BiLogoLinkedinSquare className="size-6" />
              </a>
          ...
          <div className="flex flex-col text-center">
            ...
            <div className="mb-3 md:mb-4">
              <h5 className="text-md font-semibold md:text-lg">Sarah Brown</h5>
              <h6 className="md:text-md">Marketing Director</h6>
            </div>
            <p>Sarah drives our brand's message and outreach efforts.</p>
            <div className="mt-6 grid grid-flow-col grid-cols-[max-content] gap-3.5 self-center">
              <a href="#">
                <BiLogoLinkedinSquare className="size-6" />
              </a>
        ...
        <div className="mx-auto mt-14 w-full max-w-md text-center md:mt-20 lg:mt-24">
          ...
          <p className="md:text-md">
            Join our growing team of professionals today.
          </p>
