                ...
                <div className="grid w-full auto-cols-fr grid-cols-1 items-center justify-center gap-12 md:grid-cols-2 md:gap-10 lg:gap-x-20">
                  ...
                  <div className="flex flex-col items-start">
                    ...
                    <blockquote className="text-xl font-bold md:text-2xl">
                      "The quality of the car shade structures exceeded our
                      expectations, providing excellent protection for our
                      vehicles against the elements."
                    </blockquote>
                    <div className="mt-6 flex flex-nowrap items-center gap-5 md:mt-8">
                      <div>
                        <p className="font-semibold">John Doe</p>
                        <p>Manager, Auto Park</p>
                      </div>
                      <div className="bg-background-alternative mx-4 w-px self-stretch sm:mx-0" />
                      <div>
                        <img
