...
export function Content30(props: any) {
  return (
        ...
        <div className="mx-auto max-w-[800px]">
          <div className="mb-14 flex flex-col gap-y-8 sm:flex-row sm:items-center sm:justify-between md:mb-16 md:gap-y-0">
            ...
            <div className="flex items-start gap-2">
              <a
                href="#"
                className="bg-background-secondary size-8 rounded-[1.25rem] p-1"
              >
          ...
          <div>
            <div className="mb-8 text-center md:mb-10 lg:mb-12">
              <p className="md:text-md font-semibold">Share this post</p>
          ...
          <div className="bg-border-primary my-8 h-px md:my-10 lg:my-12" />
          {/* <div className="flex flex-col items-center gap-4 text-center">
            <div>
              <img
                src="https://cdn.prod.website-files.com/624380709031623bfe4aee60/6243807090316203124aee66_placeholder-image.svg"
                alt="Logo"
                className="rounded-image size-14 rounded-full object-cover"
              />
            </div>
            <div className="grow">
              <p className="md:text-md font-semibold">John Doe</p>
              <p>Content Writer, Shade Co.</p>
            </div>
          </div> */}
        </div>
      </div>
